...
namespace TransformGizmos
{
    public class Rotation : MonoBehaviour
    {
        ...
        public UnityEvent marchingCall;
        ...
        private void Update()
        {
            ...
            scale = m_cameraDistance * m_gizmoSize * m_gizmoSize;
            transform.localScale = new Vector3(scale * 50, scale * 50, scale * 50);
            scale = m_cameraDistance * m_gizmoSize * m_gizmoSize;
            m_degreesText.transform.localScale = new Vector3(scale * 50, scale * 50, scale * 50);
